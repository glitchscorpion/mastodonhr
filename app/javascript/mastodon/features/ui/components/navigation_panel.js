...
const NavigationPanel = () => (
  <div className='navigation-panel'>
    ...
    <NavLink className='column-link column-link--transparent' to='/accounts/108557429764577695'><Icon className='column-link__icon' id='info-circle' fixedWidth /><FormattedMessage id='navigation_bar.information_acct' defaultMessage='MastoHR info' /></NavLink>
    <NavLink className='column-link column-link--transparent' to='/tags/mastohr'><Icon className='column-link__icon' id='hashtag' fixedWidth /><FormattedMessage id='navigation_bar.hashtag_fedibird' defaultMessage='Topics' /></NavLink>
    ...
    <NavLink className='column-link column-link--transparent' to='/directory'><Icon className='column-link__icon' id='address-book-o' fixedWidth /><FormattedMessage id='getting_started.directory' defaultMessage='Profile directory' /></NavLink>
