...
const messages = defineMessages({
  ...
  information_acct: { id: 'navigation_bar.information_acct', defaultMessage: 'MastoHR info' },
  hashtag_fedibird: { id: 'navigation_bar.hashtag_fedibird', defaultMessage: 'mastohr' },
...
class GettingStarted extends ImmutablePureComponent {
  ...
  render () {
    ...
    if (multiColumn) {
      ...
      navItems.push(
        <ColumnLink key='information_acct' icon='info-circle' text={intl.formatMessage(messages.information_acct)} to='/accounts/108902006406298809' />,
        <ColumnLink key='hashtag_fedibird' icon='hashtag' text={intl.formatMessage(messages.hashtag_fedibird)} to='/tags/verum' />,
      );
    ...
    height += 48*2;
      ...
      navItems.push(
      <ColumnLink key='information_acct' icon='info-circle' text={intl.formatMessage(messages.information_acct)} to='/accounts/108557429764577695' />,  
      <ColumnLink key='hashtag_fedibird' icon='hashtag' text={intl.formatMessage(messages.hashtag_fedibird)} to='/tags/mastohr' />,
      );
